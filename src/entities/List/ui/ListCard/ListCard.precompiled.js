import Handlebars from 'handlebars/runtime.js';
  ...
  return "            <div class=\"list-card__title-editing\">\n                <textarea class=\"list-card__title-input\" placeholder=\"Введите название списка...\">"
    ...
    + "</textarea>\n                <button class=\"list-card__save\" type=\"button\" aria-label=\"Сохранить\">\n                    ✓\n                </button>\n            </div>\n";
  ...
  return "            <h3 class=\"list-card__title\">"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"title") || (depth0 != null ? lookupProperty(depth0,"title") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"title","hash":{},"data":data,"loc":{"start":{"line":11,"column":41},"end":{"line":11,"column":50}}}) : helper)))
    + "</h3>\n            <button class=\"list-card__edit\" type=\"button\" aria-label=\"Редактировать название\">\n                <img src=\"/images/edit-icon.svg\" alt=\"Редактировать\" />\n            </button>\n";
  ...
  return "<div class=\"list-card\" data-list-id=\""
    ...
    + "        <button class=\"list-card__delete\" type=\"button\" aria-label=\"Удалить список\">\n            ×\n        </button>\n    </div>\n\n    <div class=\"list-card__tasks\">\n    </div>\n\n    <div class=\"list-card__footer\">\n        <button class=\"list-card__add\" type=\"button\">\n            Добавить карточку +\n        </button>\n    </div>\n</div>";
},"useData":true});
