import Handlebars from 'handlebars/runtime.js';
  ...
  return "            <textarea class=\"task-window__input\">"
    ...
    + "</textarea>\n            <div class=\"task-window__actions\">\n                <span class=\"task-window__save\">✓</span>\n            </div>\n";
  ...
  return "            <span class=\"task-window__checkbox "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"isCompleted") : depth0),{"name":"if","hash":{},"fn":container.program(4, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":17,"column":47},"end":{"line":17,"column":102}}})) != null ? stack1 : "")
